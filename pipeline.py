...
LUA_SHA1 = get_hash(os.path.join(CWD, 'storyfire.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'video':
                wget_args.extend(['--warc-header', 'storyfire-video: '+item_value])
                wget_args.append('https://storyfire.com/video-details/'+item_value)
            elif item_type == 'user':
                wget_args.extend(['--warc-header', 'storyfire-user: '+item_value])
                wget_args.append('https://storyfire.com/user/'+item_value)
            else:
